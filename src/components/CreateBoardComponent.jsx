...
class CreateBoardComponent extends Component {
    ...
    getTitle(){
        console.log("getTitle" + this.state.no);
        if (this.state.no === '_create') {
            return <h3 className="text-center">새글을 입력해주세요 </h3>
        }else{
            return <h3 className="text-center">{this.state.no} 번 글을 수정 중입니다</h3>
        }
    }


    componentDidMount() {
        console.log("componentDidMount" + this.state.no);
